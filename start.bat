...
set CP="%DIRNAME%beans.jar"
set CP=%CP%;"%DIRNAME%data.jar"
set CP=%CP%;"%DIRNAME%openbravopos.jar"
...
start /B java -cp %CP% -Djava.util.logging.config.file="%DIRNAME%logging.properties" -Djava.library.path="%DIRNAME%lib/Windows/i368-mingw32" -Ddirname.path="%DIRNAME%./" com.openbravo.pos.forms.StartPOS %1
