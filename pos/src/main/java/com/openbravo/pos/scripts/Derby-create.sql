...
CREATE UNIQUE INDEX BRANDS_NAME_INX ON BRANDS(NAME);
INSERT INTO BRANDS(ID, NAME) VALUES ('000', 'Brand Standard');
...
CREATE TABLE PRODUCTS (
    ...
    CONSTRAINT PRODUCTS_FK_2 FOREIGN KEY (BRAND) REFERENCES BRANDS(ID),
